...
public class MainActivity extends SherlockFragmentActivity implements TabListener {
    ...
    Editor edit;
    private final String TAG_PREF_FILE = "pref_file", TAG_PREF_HOUR = "offset_time";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        digitalClock.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                View change_view = LayoutInflater.from(MainActivity.this).inflate(R.layout.change_time_layout, null);

                timePicker = (TimePicker) change_view.findViewById(R.id.timePicker);
                timePicker.setIs24HourView(true);
                timePicker.setCurrentHour(now.getHours());
                timePicker.setCurrentMinute(now.getMinutes());

                isCheckSystemTime = (CheckBox) change_view.findViewById(R.id.checkboxSysTime);
                ...
                d.setPositiveButton(getString(android.R.string.ok), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!isCheckSystemTime.isChecked() && newDate == null) {
                            now.setSeconds(0);
                            digitalClock.setTime(now.getTime());
                            savePreferences(now.getTime());
                        } else if (!isCheckSystemTime.isChecked() && newDate != null) {
    ...
    private void createTabs(int orientation) {
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT)
            tv.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_menu_home, 0, 0);
        else {
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT)
            tv.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_menu_map, 0, 0);
        else {
            tv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_menu_map, 0, 0, 0);
        }
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT)
            tv.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_menu_chrono, 0, 0);
        else {
            tv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_menu_chrono, 0, 0, 0);
        }
        tab = getSupportActionBar().newTab().setCustomView(tv);
        tab.setTabListener(this);
        getSupportActionBar().addTab(tab);
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT)
            tv.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_menu_ffsa, 0, 0);
        else {
            tv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_menu_ffsa, 0, 0, 0);
        }
        tab = getSupportActionBar().newTab().setCustomView(tv);
        tab.setTabListener(this);
        getSupportActionBar().addTab(tab);
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT)
            tv.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_menu_weather, 0, 0);
        else {
            tv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_menu_weather, 0, 0, 0);
        }
        tab = getSupportActionBar().newTab().setCustomView(tv);
        tab.setTabListener(this);
        getSupportActionBar().addTab(tab);
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT)
            tv.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_menu_contact, 0, 0);
        else {
            tv.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_menu_contact, 0, 0, 0);
        }
        tab = getSupportActionBar().newTab().setCustomView(tv);
        tab.setTabListener(this);
        getSupportActionBar().addTab(tab);
    ...
    public void onTabSelected(Tab tab, FragmentTransaction ft) {
        ...
        if (tab.getPosition() == 0) {
            ...
            AnalyticsManager.trackScreen(MainActivity.this, AnalyticsManager.KEY_PAGE_HOME);
        ...
        if (tab.getPosition() == 1) {
            ...
            AnalyticsManager.trackScreen(MainActivity.this, AnalyticsManager.KEY_PAGE_MAP);
            AnalyticsManager.dispatch();
        }
        if (tab.getPosition() == 2) {
            ...
            AnalyticsManager.trackScreen(MainActivity.this, AnalyticsManager.KEY_PAGE_CHRONO);
            AnalyticsManager.dispatch();
        }
        if (tab.getPosition() == 3) {
            ...
            AnalyticsManager.trackScreen(MainActivity.this, AnalyticsManager.KEY_PAGE_FFSA);
            AnalyticsManager.dispatch();
        }
        if (tab.getPosition() == 4) {
            ...
            AnalyticsManager.trackScreen(MainActivity.this, AnalyticsManager.KEY_PAGE_METEO);
            AnalyticsManager.dispatch();
        }
        if (tab.getPosition() == 5) {
            ...
            AnalyticsManager.trackScreen(MainActivity.this, AnalyticsManager.KEY_PAGE_CONTACTS);
            AnalyticsManager.dispatch();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.about:
            ...
            View v = LayoutInflater.from(this).inflate(R.layout.about_layout, null);
            ...
            contact.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String emailSubject = "Contact Android " + getString(R.string.app_name);
