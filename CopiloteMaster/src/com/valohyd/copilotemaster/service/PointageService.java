...
public class PointageService extends Service {
     ...
     */
    public void startCountDownTimer(final long millisInFuture, long countDownInterval) {
        ...
        remainTimer = new CountDownTimer(millisInFuture, countDownInterval) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Notification noti = new Notification.Builder(PointageService.this).setContentTitle("Pointage")
                        .setContentText("temps : " + hours + ":" + minutes + ":" + secondes)
                        .setSmallIcon(R.drawable.gps_started).setContentIntent(pIntent).build();
